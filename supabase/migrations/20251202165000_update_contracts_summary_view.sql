...
SELECT
  ...
  COALESCE(ca.areas_ids, ARRAY[]::uuid[]) as areas_ids,
  COALESCE(cc.centers_names, ARRAY[]::text[]) as centers_names,
  COALESCE(cc.centers_ids, ARRAY[]::uuid[]) as centers_ids
FROM contracts c
